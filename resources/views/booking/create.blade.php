        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ route('booking.create', $geodata->id) }}" class="mt-6 space-y-6">
                        @csrf
                        @method('post')
                        ...
                        <div>
                        <label for="meeting-time">Choose your booking date and time:</label>
